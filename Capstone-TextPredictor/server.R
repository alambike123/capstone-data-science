...
twoGrams <- read.csv('twoGram.csv', header = TRUE, stringsAsFactors = FALSE)
threeGrams <- read.csv('threeGram.csv', header = TRUE, stringsAsFactors = FALSE)
fourGrams <- read.csv('fourGram.csv', header = TRUE, stringsAsFactors = FALSE)
fiveGrams <- read.csv('fiveGram.csv', header = TRUE, stringsAsFactors = FALSE)
